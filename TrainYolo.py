...
NUM_TL_IMAGES = 2160
TRAIN_SET_SIZE = int( math.floor( NUM_TL_IMAGES * 0.8 ))
BATCH_SIZE = 1
NUM_EPOCHS = 100
...
tlImagesPklFilename = '/home/daeyoung-snu/YoloTensorFlow229-modified/LISA_TL_dataset/TL_AnnotatedImages.pkl'
...
if __name__ == '__main__':
	...
	checkpoint_path = '/home/daeyoung-snu/YoloTensorFlow229-modified/yolo.ckpt'
	best_val_mAP = -1 * float('inf')
	annotatedImages = getData(getPickledData,tlImagesPklFilename)
