...
class YOLO_TrainingNetwork:
    ...
    def add_placeholders(self):
        ...
        self.gt_classes = tf.placeholder(tf.float32,shape=[49,6],name='GT_CLASSES')
    ...
    def create_network(self):
        ...
        connected_layer31 = self.create_connected_layer(dropout_layer30, 784, False, 31, 'ConnectedLayer31')
